...
{
	local first_option all_short_options='adlzqbuignpxtvceh'
	first_option="${1:0:1}"
...
_positionals=()
_arg_operation="ATOM, MOLECULE, ADDON, APIM, APIMv2, DCP, CONTROLPLANE"
...
boomi BOOTSTRAP
boomi BOOTSTRAP --name NAME [--token TOKEN]"
	printf 'Usage: %s [-a|--(no-)add] [-d|--(no-)delete] [-l|--(no-)list] [-z|--(no-)purge] [-q|--account <arg>] [-b|--backend <arg>] [-u|--user <arg>] [-i|--api <arg>] [-g|--gateway <arg>] [-n|--name <arg>] [-p|--path <arg>] [-x|--port <arg>] [-t|--token <arg>] [-v|--vm <arg>] [-c|--container <arg>] [-e|--node <arg>] [-h|--help] [<operation>]\n' "$0"
	printf '\t%s\n' "<operation>: o (default: 'ATOM, MOLECULE, ADDON, APIM, APIMv2, DCP, CONTROLPLANE')"
	...
	printf '\t%s\n' "-q, --account: The name of the Boomi Account (no default)"
	printf '\t%s\n' "-b, --backend: The APIIDA Backend URL (no default)"
	printf '\t%s\n' "-u, --user: The Boomi User (no default)"
	printf '\t%s\n' "-i, --api: The Boomi User API Token (no default)"
	printf '\t%s\n' "-g, --gateway: The Boomi Gateway ID (no default)"
	...
	printf '\t%s\n' "-t, --token: The Installer Token for the Atom/Molecule/ControlPlane (no default)"
